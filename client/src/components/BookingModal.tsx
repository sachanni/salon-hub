...
export default function BookingModal({ isOpen, onClose, salonName, salonId }: BookingModalProps) {
  ...
  useEffect(() => {
    ...
    if (isOpen) {
      ...
      console.log('BookingModal opened - salonId:', salonId, 'salonName:', salonName);
      fetchServices();
    }
